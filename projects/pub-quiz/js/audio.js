...
export const MELODIES = {
    beethoven5: {
        ...
        bpm: 108,
        notes: [
            ['rest', 0.5], ['G4', 0.5], ['G4', 0.5], ['G4', 0.5], ['Eb4', 2.5],
            ['rest', 0.5], ['F4', 0.5], ['F4', 0.5], ['F4', 0.5], ['D4', 3],
            ['rest', 0.5], ['G4', 0.5], ['G4', 0.5], ['G4', 0.5], ['Eb4', 2.5],
            ['rest', 0.5], ['F4', 0.5], ['F4', 0.5], ['F4', 0.5], ['D4', 3],
        ],
    },
    ...
    furElise: {
        ...
        notes: [
            ...
            ['E5', 0.25], ['B4', 0.25], ['D5', 0.25], ['C5', 0.25], ['A4', 0.75],
            ['C4', 0.25], ['E4', 0.25], ['A4', 0.25], ['B4', 0.75],
            ['E4', 0.25], ['G#4', 0.25], ['B4', 0.25], ['C5', 0.75],
            ['E4', 0.25],
            ['E5', 0.25], ['D#5', 0.25], ['E5', 0.25], ['D#5', 0.25],
            ['E5', 0.25], ['B4', 0.25], ['D5', 0.25], ['C5', 0.25], ['A4', 0.75],
            ['C4', 0.25], ['E4', 0.25], ['A4', 0.25], ['B4', 0.75],
    ...
    williamTell: {
        ...
        notes: [
            ['G4', 0.5], ['G4', 0.5], ['G4', 1],
            ['G4', 0.5], ['G4', 0.5], ['G4', 1],
            ['G4', 0.5], ['G4', 0.5], ['G4', 0.5], ['G4', 0.5], ['G4', 1],
            ['C5', 0.5], ['C5', 0.5], ['C5', 1],
            ['C5', 0.5], ['C5', 0.5], ['C5', 1],
            ['C5', 0.5], ['C5', 0.5], ['C5', 0.5], ['C5', 0.5], ['C5', 1],
            ['E5', 0.5], ['E5', 0.5], ['E5', 1],
            ['D5', 0.5], ['D5', 0.5], ['D5', 1],
            ['G4', 0.5], ['G4', 0.5], ['C5', 2],
        ],
    ...
    mountainKing: {
        ...
        notes: [
            ...
            ['G4', 0.5], ['F#4', 0.5], ['D4', 0.5], ['F#4', 1], ['rest', 0.5],
            ['B3', 0.5], ['C#4', 0.5], ['D4', 0.5], ['E4', 0.5],
            ['F#4', 0.5], ['D4', 0.5], ['F#4', 1],
            ['G4', 0.5], ['F#4', 0.5], ['D4', 0.5], ['F#4', 1], ['rest', 0.5],
            ['B4', 0.5], ['C#5', 0.5], ['D5', 0.5], ['E5', 0.5],
            ['F#5', 0.5], ['D5', 0.5], ['F#5', 1],
            ['G5', 0.5], ['F#5', 0.5], ['D5', 0.5], ['F#5', 1], ['rest', 0.5],
        ],
    },
    ...
    canonInD: {
        ...
        notes: [
            ...
            ['D5', 1], ['F#5', 1], ['A5', 1], ['G5', 1],
            ['F#5', 1], ['D5', 1], ['F#5', 1], ['E5', 1],
        ],
    },
    ...
    greensleeves: {
        ...
        // bpm counts quavers here: the tune is in 6/8 and reads better that way.
        bpm: 220,
        notes: [
            ['A4', 1],
            ['C5', 2], ['D5', 1], ['E5', 3],
    ...
    ruleBritannia: {
        ...
        bpm: 96,
        notes: [
            ['D5', 2], ['A4', 0.5], ['B4', 0.5], ['C#5', 0.5], ['D5', 0.5],
            ['E5', 2], ['B4', 0.5], ['C#5', 0.5], ['D5', 0.5], ['E5', 0.5],
            ['F#5', 2], ['E5', 1], ['D5', 1],
            ['A5', 1], ['A5', 1], ['A5', 1], ['G5', 0.5], ['F#5', 0.5],
            ['E5', 2], ['D5', 2],
        ],
    },
    ...
    swanLake: {
        ...
        notes: [
            ['B4', 1],
            ['F#5', 2], ['E5', 1], ['D5', 1], ['C#5', 1], ['B4', 1], ['F#5', 1],
            ['E5', 2], ['D5', 1], ['C#5', 1],
            ['B4', 3], ['rest', 1],
        ],
    },
